  ...
  mint({
    ...
    try {
      ...
      const promise = NearPromise.new(nft_contract_id).functionCall("nft_batch_mint", JSON.stringify({
        ...
        num_to_mint: 1
      }), attachedDeposit(), BigInt("100000000000000"));
      return promise.asReturn();
    } catch (error) {
      return false;
    }
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "mint", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "mint"), _class2.prototype)), _class2)) || _class);
function mint() {
